...
const JenisKue = () => {
  ...
  <li><button class="bg-transparent pointer-events-none px-4 py-2 disabled text-black transition-colors duration-150 focus:bg-main-color border border-r-0 border-main-color rounded-l-lg focus:shadow-outline">Prev</button></li>
	  <li>
    {Array.from({ length: Math.ceil(data.length / itemperPage) }, (_, index) => (
          <button onClick={() => paginate(index + 1)} className="bg-transparent px-4 py-2 text-black transition-colors duration-150 focus:bg-main-color border border-r-0 border-main-color focus:shadow-outline">
            {index + 1}
          </button>
      ))}
    </li>
    <li><button class="bg-transparent pointer-events-none px-4 py-2 text-black transition-colors duration-150 focus:bg-main-color border border-main-color rounded-r-lg focus:shadow-outline">Next</button></li>
	</ul>
  </nav>
</div>
    </div>
